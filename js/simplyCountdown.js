(function (exports) {
    ...
    simplyCountdown = function (elt, args) {
        ...
        // Set the target date as 28th December 2024, 17:30 UTC
        targetDate = new Date(Date.UTC(2024, 11, 28, 17, 30, 0)); // months are 0-indexed in JS Date
        ...
        Array.prototype.forEach.call(cd, function (countdown) {
            ...
            refresh = function () {
                ...
                if (secondsLeft > 0) {
                    days = Math.floor(secondsLeft / 86400); // 86400 seconds per day
                    secondsLeft = secondsLeft % 86400;

                    hours = Math.floor(secondsLeft / 3600); // 3600 seconds per hour
                    secondsLeft = secondsLeft % 3600;

                    minutes = Math.floor(secondsLeft / 60); // 60 seconds per minute
